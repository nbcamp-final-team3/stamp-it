...
final class StampInfoViewController: UIViewController {
    ...
    let cardContainerView = UIView().then {
        $0.backgroundColor = .clear
        $0.layer.cornerRadius = (UIScreen.main.bounds.width - 16 * 2) / 2
        $0.clipsToBounds = true
    }

    let frontInfoView = UIView().then {
    ...
    private func updateUI(with mission: StampBoardMission) {
    ...
    private func setHierarchy() {
        ...
        [
            ...
            .forEach { frontInfoView.addSubview($0) }
    ...
    private func setLayout() {
        ...
        frontInfoView.snp.makeConstraints {
            $0.edges.equalToSuperview()
        }
